...
export default function Login() {
  ...
  // Check if super admin has EVER been created
  useEffect(() => {
  ...
  const handleFirstTimeSetup = () => {
    ...
    // Create permanent super admin - ONLY ONCE
    ...
    alert(`✅ Congratulations, ${adminName}! You are now the permanent Super Admin.`);
    router.push('/dashboard/checkin');
  };

  // First-time setup screen (only shows once ever)
  if (setupMode) {
    return (
